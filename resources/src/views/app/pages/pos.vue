        ...
        <b-row v-if="!isLoading">
                ...
                <b-card no-body class="card-order">
                    <div class="main-header">
                        ...
                        <div class="header-part-right">
                            ...
                            <div class="dropdown">
                                <b-dropdown id="dropdown" text="Dropdown Button" class="m-md-2" toggle-class="text-decoration-none" no-caret right variant="link">
                                    <template slot="button-content">
                                        <i class="i-Globe text-muted header-icon" role="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></i>
                                    </template>
                                    <vue-perfect-scrollbar :settings="{
                                                suppressScrollX: true,
                                                wheelPropagation: false,
                                            }" ref="myData" class="dropdown-menu-left rtl-ps-none notification-dropdown ps scroll">
                            ...
                            <div class="dropdown">
                                <b-dropdown id="dropdown-1" text="Dropdown Button" class="m-md-2 user col align-self-end" toggle-class="text-decoration-none" no-caret variant="link" right>
                                    <template slot="button-content">
                                        <img :src="
                                                    '/images/avatar/' +
                                                    currentUser.avatar
                                                ...
                                                <b-form-group :label="$t('Tax')" append="%">
                                                    <b-input-group append="%">
                                                        <b-form-input :state="
                                                                ...
                                                                " aria-describedby="OrderTax-feedback" label="Order Tax" v-model.number="
                                                                    sale.tax_rate
                                                                " @keyup="
                                                                    keyup_OrderTax()
                                                                "></b-form-input>
                                                ...
                                                <b-form-group :label="$t('Discount')" append="%">
                                                    <b-input-group :append="
                                                        ...
                                                        <b-form-input :state="
                                                                ...
                                                                " aria-describedby="Discount-feedback" label="Discount" v-model.number="
                                                                    sale.discount
                                                                " @keyup="
                                                                    keyup_Discount()
                                                                "></b-form-input>
                                                ...
                                                <b-form-group :label="$t('Shipping')">
                                                    <b-input-group :append="
                                                        ...
                                                        <b-form-input :state="
                                                                ...
                                                                " aria-describedby="Shipping-feedback" label="Shipping" v-model.number="
                                                                    sale.shipping
                                                                " @keyup="
                                                                    keyup_Shipping()
                                                                "></b-form-input>
                                ...
                                <b-row>
                                    ...
                                    <b-col lg="6" md="6" sm="12">
                                        <validation-provider name="Product Price" :rules="{
                                            ...
                                            <b-form-group :label="
                                                        ...
                                                        '*'
                                                    " id="Price-input">
                                                <b-form-input label="Product Price" v-model="
                                                            detail.Unit_price
                                                        " :state="
                                                            getValidationState(
                                                                validationContext
                                    ...
                                    <b-col lg="6" md="6" sm="12">
                                        <validation-provider name="Tax" :rules="{
                                            ...
                                            <b-form-group :label="
                                                    ...
                                                    ">
                                                <b-input-group append="%">
                                                    <b-form-input label="Tax" v-model="
                                                                detail.tax_percent
                                                            " :state="
                                                                getValidationState(
                                                                    validationContext
                                    ...
                                    <b-col lg="6" md="6" sm="12">
                                        <validation-provider name="Discount Rate" :rules="{
                                            ...
                                            <b-form-group :label="
                                                        ...
                                                        '*'
                                                    ">
                                                <b-form-input label="Discount" v-model="
                                                            detail.discount
                                                        " :state="
                                                            getValidationState(
                                                                validationContext
                                    ...
                                    <b-col lg="12" md="12" sm="12" v-show="detail.is_imei">
                                        <b-form-group :label="
                                                ...
                                                ">
                                            <b-form-input label="Add_product_IMEI_Serial_number" v-model="detail.imei_number" :placeholder="
                                                        $t(
                                                            'Add_product_IMEI_Serial_number'
                                                        )
                                                    "></b-form-input>
                ...
                <b-card class="list-grid">
                        ...
                        <b-col md="12" class="mt-2 mb-2">
                            <div id="autocomplete" class="autocomplete">
                                <input :placeholder="
                                        ...
                                        " @keyup="search(search_input)" @focus="handleFocus" @blur="handleBlur" ref="product_autocomplete" class="autocomplete-input" />
                    ...
                    <b-row>
                        <b-col md="12" class="mt-4">
                            <b-pagination @change="Product_onPageChanged" :total-rows="product_totalRows" :per-page="product_perPage" v-model="product_currentPage" class="my-0 gull-pagination align-items-center" align="center" first-text last-text>
            ...
            <b-sidebar id="sidebar-brand" :title="$t('ListofBrand')" bg-variant="white" right shadow>
                <div class="px-3 py-2">
                    <b-row>
                        <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                            <div @click="GetAllBrands()" :class="{ 'brand-Active': brand_id == '' }" class="card o-hidden bd-highlight m-1">
                                <div class="list-thumb d-flex">
                            ...
                            <div class="card o-hidden bd-highlight m-1" v-for="brand in paginated_Brands" :key="brand.id" @click="Products_by_Brands(brand.id)" :class="{
                    ...
                    <b-row>
                        <b-col md="12" class="mt-4">
                            <b-pagination @change="BrandonPageChanged" :total-rows="brand_totalRows" :per-page="brand_perPage" v-model="brand_currentPage" class="my-0 gull-pagination align-items-center" align="center" first-text last-text>
                                <p class="list-arrow m-0" slot="prev-text">
                                    <i class="i-Arrow-Left text-40"></i>
                                </p>
                                <p class="list-arrow m-0" slot="next-text">
                ...
                <div class="px-3 py-2">
                    <b-row>
                        <div class="col-md-12 d-flex flex-row flex-wrap bd-highlight list-item mt-2">
                            ...
                            <div class="card o-hidden bd-highlight m-1" v-for="category in paginated_Category" :key="category.id" @click="Products_by_Category(category.id)" :class="{
                                        'brand-Active':
                    ...
                    <b-row>
                        <b-col md="12" class="mt-4">
                            <b-pagination @change="Category_onPageChanged" :total-rows="category_totalRows" :per-page="category_perPage" v-model="category_currentPage" class="my-0 gull-pagination align-items-center" align="center" first-text last-text>
                                <p class="list-arrow m-0" slot="prev-text">
                                    <i class="i-Arrow-Left text-40"></i>
                                </p>
                                <p class="list-arrow m-0" slot="next-text">
                    ...
                    <div style="max-width: 400px; margin: 0px auto">
                        <div class="info">
                            ...
                            <p>
                                ...
                                <span v-show="pos_settings.show_address">{{ $t("Adress") }} :
                                    {{ invoice_pos.setting.CompanyAdress }}
                                    <br /></span>
                                <span v-show="pos_settings.show_email">{{ $t("Email") }} :
                                    {{ invoice_pos.setting.email }} <br /></span>
                                <span v-show="pos_settings.show_phone">{{ $t("Phone") }} :
                                    {{ invoice_pos.setting.CompanyPhone }}
                                    <br /></span>
                                <span v-show="pos_settings.show_customer">{{ $t("Customer") }} :
                        ...
                        <div id="legalcopy" class="ml-2">
                            ...
                            <div id="bar" v-show="pos_settings.show_barcode">
                                <barcode class="barcode" :format="barcodeFormat" :value="invoice_pos.sale.Ref" textmargin="0" fontoptions="bold" fontSize="15" height="25" width="1"></barcode>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <validation-provider name="Received Amount" :rules="{
                                            ...
                                            <b-form-group :label="
                                                ...
                                                <b-form-input @keyup="
                                                        ...
                                                        " label="Received_Amount" :placeholder="
                                                            $t(
                                                                'Received_Amount'
                                                            )
                                                        " v-model.number="
                ...
                <b-modal hide-footer size="lg" id="New_Customer" :title="$t('Add')">
                    <b-form @submit.prevent="Submit_Customer">
                        <b-row>
                                ...
                                <validation-provider name="Name Customer" :rules="{ required: true }" v-slot="validationContext">
                                    <b-form-group :label="
                                        ...
                                        <b-form-input :state="
                                                ...
                                                " aria-describedby="name-feedback" label="name" v-model="client.name" :placeholder="
                                                    $t('CustomerName')
                                                "></b-form-input>
                            ...
                            <!-- Customer Email -->
                            <b-col md="6" sm="12">
                                <validation-provider name="Email customer" :rules="{ required: true }" v-slot="validationContext">
                                    <b-form-group :label="$t('Email') + ' ' + '*'">
                                        <b-form-input :state="
                                                    getValidationState(
                                                        validationContext
                                                    )
                                                " aria-describedby="Email-feedback" label="Email" v-model="client.email" :placeholder="$t('Email')"></b-form-input>
    ...
    methods: {
        ...
        CaclulTotal() {
            ...
            this.GrandTotal = parseFloat(
                total_without_discount + this.sale.TaxNet + this.sale.shipping + this.sale.installation
            );
